...
- 喜欢音乐（加红心）
- 收藏音乐到歌单
- 自建歌单编辑与歌曲整理（支持拖拽排序、单步微调与移除歌曲，云端实时同步）
- 播放/下载 MV/视频
- 搜索 单曲/歌单/专辑/视频/用户
...
- Material 3 Expressive UI、播放栏液态玻璃特效、Android 波浪动态进度条、歌曲列表迷你封面
- 自定义主题颜色、侧边栏自定义背景图片、全局暗色模式与顶栏高对比度亮暗自适应
- 播放控制增强（支持 Spotify 风格上一首智能跳转：播放超过 3 秒先回开头，再次点击切换上一首）
